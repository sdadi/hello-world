...
var q = browser.findElement(webdriver.By.name('q'));
q.sendKeys('tuts+ code');
q.click();
var btnGo = browser.findElement(webdriver.By.name('btnK'));
//browser.actions().mouseMove(btnGo).perform();
btnGo.click();
